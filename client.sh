...
sed -i 's,uri ldapi:///,uri ldap://ldap-server2,g' /etc/ldap.conf
...
ldap-auth-config        ldap-auth-config/rootbinddn     string  cn=ldapadm,dc=nti310,dclocal" > /tmp/ldap_debconf
